...
| `SCRIPTUM_JDT_LS_VMARGS` | No | Overrides the seeded Java language-server VM args |
| `SCRIPTUM_GRADLE_JVMARGS` | No | Overrides the seeded Gradle daemon/import VM args |
