...
export async function createApp(
	...
	async function dispatch(
		...
		if (url.pathname === "/login/legion" && request.method === "GET") {
			...
			return redirect(
				`${storage.config.legionBaseUrl}/sso/authorize?app=fabrica&return_to=${encodeURIComponent(returnTo)}`,
			);
		}
		...
		// /login/legion, /logout, /fabrica-icon.png, /assets/*) are handled above.
